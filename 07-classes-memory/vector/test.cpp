...
TEST_CASE("Algorithms") {
    ...
    {
        const Vector v1 = {4, 0, -3, 4, 1, 2};
        const Vector v2(v1.Size());
...
TEST_CASE("Valid after move") {  // NOLINT(readability-function-cognitive-complexity)
    {
        Vector a = {1, 2};
        auto b = a;
        a.Clear();
