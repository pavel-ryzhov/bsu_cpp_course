...
void CheckTokens(  // NOLINT(readability-function-cognitive-complexity)
    const std::string& expression, const std::vector<Token>& tokens) {
...
TEST_CASE("Complex") {
    ...
    CHECK(
        EvaluateExpression("4532 * 54254*(452- 120 +43 - -(5434 + 451 +541) ) / 67/ 123") ==
        202'915'174);
    CHECK(EvaluateExpression("-3495 / 92 -(-34122 +5123) / 21 * 3 +-15") == 4088);
}
