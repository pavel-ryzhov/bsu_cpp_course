...
git clone git@gitlab.manytask.org:bsu-cpp/students-2024-fall/<твой репозиторий>
...
git remote add upstream git@gitlab.manytask.org:bsu-cpp/public-2024-fall.git
```
