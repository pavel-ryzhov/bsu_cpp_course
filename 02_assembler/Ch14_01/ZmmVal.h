...
struct alignas(64) ZmmVal {
   ...
   private:
    template <typename T>
    std::string ToStringInt(const T* x, size_t n, size_t w, size_t select) {
    ...
    template <typename T>
    std::string ToStringUint(const T* x, size_t n, size_t w, size_t select) {
        std::ostringstream oss;
    ...
    template <typename T>
    std::string ToStringHex(const T* x, size_t n, size_t w, size_t select) {
        std::ostringstream oss;
    ...
    template <typename T>
    std::string ToStringFP(const T* x, size_t n, size_t w, int p, size_t select) {
        std::ostringstream oss;
